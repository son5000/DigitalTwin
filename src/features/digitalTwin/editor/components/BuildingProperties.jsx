...
export default function BuildingProperties({ building, floorCount, onChange, onAddFloor, onEnter }) {
  if (!building) {
    return (
    ...
    <section className={styles.panel}>
          ...
          <select
            ...
            onChange={(event) => {
              ...
              onChange({
                ...
                parameters: { roofType: template?.roofType ?? building.parameters.roofType },
              });
            }}
          >
      ...
      <div className={styles.section}>
        ...
        <div className={styles.floorSummary}>
          ...
          <button type="button" onClick={onAddFloor}>+ 층 추가</button>
        </div>
      </div>
