...
export const WORLD_WIZARD_STEPS = Object.freeze([
  ...
  },
  {
    ...
    label: "설비 상세",
    shortLabel: "설비 상세",
    eyebrow: "ASSET · SENSOR · OBSERVATION · ALIGNMENT",
    title: "실제 설비 자산과 센서 관측 관계를 구성하세요",
    description: "Proxy와 스캔 자산을 정합하고 센서·카메라, 서버 키와 관측 포인트를 연결합니다.",
    primaryLabel: "설비 상세 저장",
    contextLabel: "설비 상세",
  },
]);
