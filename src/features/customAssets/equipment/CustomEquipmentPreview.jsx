...
export default function CustomEquipmentPreview({ asset, selectedPartId, selectedPortId, selectedPortRef = null, placementType = null, placementDirectionId = "E", theme, transformMode, focusKey, onSelectPart, onSelectPort, onTransformPart, onPlacePart, onPlacementState }) {
  ...
  useEffect(() => {
    ...
    const colors = SCENE_THEMES[theme] ?? SCENE_THEMES.dark; runtime.scene.background = new THREE.Color(colors.background); runtime.model = createCustomEquipmentGroup(asset, { selectedPartId, selectedPortId, showPorts: true, exposeParts: true, edgeColor: colors.equipmentEdge, selectionColor: colors.selection }); runtime.scene.add(runtime.model);
  ...
  }, [asset, focusKey, placementType, selectedPartId, selectedPortId, theme, transformMode]);
