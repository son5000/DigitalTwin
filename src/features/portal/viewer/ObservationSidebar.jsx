...
export default function ObservationSidebar({ assets, activeMenu, collapsed, mobileOpen, query, selectedAssetId, onActiveMenuChange, onAssetSelect, onCollapse, onLogout, onQueryChange }) {
  return <aside className={`${styles.sidebar} ${collapsed ? styles.sidebarCollapsed : ""} ${mobileOpen ? styles.sidebarMobileOpen : ""}`} aria-label="관측 메뉴">
    ...
    <div className={styles.sidebarFooter}><button type="button" onClick={onLogout}>랜딩으로 돌아가기</button></div>
  </aside>;
}
